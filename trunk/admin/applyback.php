...
站点名: 
<input type="text" name="sitename" value="<?php echo $registroe["site_name"] ?>"><br>
站点id: 
...
<td>";
?>
<form method="post" action="index.php?op=58&id=<?php echo $registro["id"] ?>&siteid=<?php echo $registro["site_id"] ?>&option=edit">
<input type="submit" value="编辑" class="button">
</form>
</td>
<td>
<form method="post" action="index.php?op=58&id=<?php echo $registro["id"] ?>&siteid=<?php echo $registro["site_id"] ?>&option=delete">

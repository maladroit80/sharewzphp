...
<td>";
?>
<form method="post" action="index.php?op=611&id=<?php echo $registro["id"] ?>&option=edit">
<input type="submit" value="编辑/登记返佣" class="button">
</form>
</td>
<td>
<form method="post" action="index.php?op=611&id=<?php echo $registro["id"] ?>&option=delete">

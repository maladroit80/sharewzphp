...
你的订购已经提交，在我们允许你的申请之前，你必须通过支付宝付款 <?php echo $rowe["price"]; ?> 元. </b></a><br>
<br>
<div align="center">
...
高级会员
  ...
  <p>高级会员<b><?php echo $rowe["price"] ?></b>元1年 </p>
...
<input type="hidden" name="user" value="<?php echo $dep1 ?>">
<input type="hidden" name="pemail" value="<?php echo $dep2 ?>">
<input type="hidden" name="email" value="<?php echo $dep3 ?>">
<input type="hidden" name="ip" value="<?php echo $dep4 ?>"><br>
